...
\begin{figure}
    ...
    \floatfoot{\noindent Working individuals are assigned to groups that are time
        ...
        space. The share of individuals who attend in a way that has transmission potential
...
meetings and physical distancing (such as virtual meetings with friends).
...
\begin{figure}
    ...
    \caption{\textbf{Share of individuals who do a Rapid Test.}}
    \floatfoot{\noindent ...}
