...
Supplementary Material~\ref{sub:data_course_of_disease}). Whereas susceptibility to the
viruses differs by age, the infection probabilities are independent of age conditioned
on the type of contact \cite{Jones2021}.
