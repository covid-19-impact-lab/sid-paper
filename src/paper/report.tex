...
in quantitative terms.\comment[id=K]{feedback from Philipp:
\begin{itemize}
    \item he would suggest to lay more focus on explaining the mechanisms behind our
    results
    \item he suggests we should try to get some form of confidence bands or standard errors
    \item he got the wrong impression that we only have three mechanisms and that the
    rapid tests are the residual.
\end{itemize}
}
