...
Since early 2020,
%&%&%& \comment[id=J]{Put stronger focus on time dependent rapid test
%&%&%& sensitivity (30\% before day of onset of infectiousness)}
...
vaccination-induced herd immunity \citep{Swaminathan2021}.
%&%&%& \comment[id=HM]{Need to find some more scientific citation before submission}
In the meantime, it is of utmost
...
to][]{Grimm2021}.
%&%&%& \comment[id=HM]{Need to look for non-economists}
...
%&%&%& \comment[id=HM]{Removed ``and whether she reduces her contacts if she tests positive or
%&%&%& develops symptoms'' -- does not fit here. If anything, add footnote, but it seems like
%&%&%& this is a detail that is just distracting right here. Make sure to describe clearly and
...
Supplementary Material \ref{sec:model}]{McFadden1989}.
%&%&%& \comment[id=HM]{Make referencemore specific once Appendix has new structure}
...
%&%&%& \comment[id=K]{Must be verified once results are final.}
...
\citep{Vlachos2021}
%&%&%& \comment[id=HM]{Need a back-of the envelope calculation}
