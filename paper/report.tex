...
\citep{Jones2021}.\comment[id=HM]{Seems broadly standard, can we cite someone?}
...
highest for meeting other people.\comment[id=HM]{True?}\comment[id=K]{FALSE. We only have one private demand threshold (over time) which is the same for own symptoms and no PCR test, household member with symptoms or positive test and for having a weekly meeting with friends.}.
...
2020.\comment[id=HM]{True?} See Appendix~\comment[id=HM]{Reference}
\comment[id=K]{We have not done the decomposition for 2020 yet. Is on my todo list}
\comment[id=HM]{I guess my question was whether I was missing any factors.}
