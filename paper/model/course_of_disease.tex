...
\begin{figure}[!tp]
    ...
    \figurenotes{
        The figure depicts the course of the disease from infection to either the state
...
\footnotetext{
    Detailed information on the calibration of the disease parameters is available as
    part of our
    \href{https://sid-dev.readthedocs.io/en/latest/reference_guides/epi_params.html}{online documentation}.
}
