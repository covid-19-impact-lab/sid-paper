...
\begin{figure}   % Figure 1
    ...
    \floatfoot{\noindent \textit{Note:}
        ...
        influence of an agent's contacts to other agents on infections. Demographic characteristics
        set the baseline number of contacts in different networks ($\eta$). The agents may
