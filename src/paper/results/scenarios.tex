...
\end{figure}
 ...
 \comment[id=K]{HM: Why are the baseline cases above the three other scenarios?

  \begin{itemize}
    \item there are \textbf{less} vaccinations in the robustness check
    \item the "true" work multiplier is on average approx. equal to the value that we set
  \end{itemize}

  How do the numbers of tests compare?
...
\end{figure}
 ...
 \commend[id=K]{Describe that random tests are more effective at detecting cases and that
