\subsection{Simulated Rapid Test Statistics}
...
Figure~\ref{fig:rapid_tests_false_positive_rate} shws that the false
...
of beeing infected. The low false negative rate of 0.2\% looks very low. As discussed
