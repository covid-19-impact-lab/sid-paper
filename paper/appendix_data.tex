...
\begin{figure}[ht]
    ...
    \figurenotes{The figure shows the distribution of random non-work contacts by age
        groups. A row shows the share of contacts a certain age group has with all other
...
Figure~\ref{fig:assortativity}\comment[id=HM]{So no work in here? How about school? Can
we add a column with marginals and another one with work / (school?), too?} shows that
...
\begin{figure}[ht]
    ...
    \figurenotes{The figure shows the work mobility as reported by \cite{Google2021}. We
        take this as a proxy of the share of workers who are not in home office, i.e.
        who still have physical work contacts. The figure interpolates over weekends as
        we handle weekend effects through information on work on weekends in the German
        census data we use.}
\end{figure}
...
\begin{figure}
    ...
    \caption{\textbf{Share of Individuals that do a Rapid Test.} \textcolor{red}{J: Talk
        about the interpretation of each line.}}
...
\begin{figure}[ht]
    ...
    \figurenotes{The figure compares the share of individuals who have ever done a rapid
