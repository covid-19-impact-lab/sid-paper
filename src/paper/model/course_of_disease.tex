...
Table~\ref{tab:disease_and_vacc_model}.\comment[id=K]{@Janos: Is this what you wanted
("Replace this by a link to the relevant table with parameters in the data appendix, once
we have that table")}
