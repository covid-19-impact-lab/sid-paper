...
This clearly shows that the large effect of rapid tests on the infection dynamic
...
\begin{figure}   % Number of True Positive / False Positive / True Negative / False Negative
    ...
    \floatfoot{\noindent \textit{Note:}
        ...
        containing the pandemic. All results are averaged over 30 simulation runs.
...
\begin{figure} % True Positive / False Positive / True Negative / False Negative Rate
    ...
    \floatfoot{\noindent \textit{Note:}
        ...
        share of negative tests done by infected individuals.
