...
\begin{enumerate}
    \item In part, incorrect references are also used, especially for the assumption of
          ...
          \response{%
              We would like to thank the reviewer for spotting this mistake of ours. We
    ...
    \item In the development of the mathematical model, apparently only the knowledge
          ...
          \response{%
              ...
              Note that we submitted the original manuscript in early September 2021;
              the calculations had been done some time before that.

              We therefore ran additional simulations with updated and more conservative
              assumptions on the sensitivity of rapid tests (Appendix~\ref{subsec:robustness_rapid_test_sensitivity}) and found that
