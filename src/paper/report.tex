...
\begin{figure}   % Figure 1
    ...
    \floatfoot{\noindent \textit{Note:} A        % formal
        ...
        Figure~\ref{fig:model_rapid_tests}. For each reason only a share of eligible
        individuals receive a test depending on an individual compliance parameter.
...
tests\deleted[id=K]{offered by employers or follows up on private reasons}% compliance also determines who is tested in education settings
...
testing---the detection rate is on average 80\% higher for individuals above age 80
