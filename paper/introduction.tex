...
\footnotetext{
    The code can be found at \url{https://github.com/covid-19-impact-lab/sid} and the
    documentation with tutorials and background information at
...
The model has previously been applied to predict the effect of schooling policies,
