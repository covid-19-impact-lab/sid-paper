...
contacts.\comment[id=J]{Write that the exact numbers are hard to interpret and show
the infections by channel heatmap more prominently than the infection probabilities}
