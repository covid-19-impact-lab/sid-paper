...
\citep{Cheng2021}\comment[id=HM]{https://science.sciencemag.org/content/early/2021/05/19/science.abg6296}
...
\comment[id=HM]{Positive rates along the three channels might be nice here, if previous
comment is not a quant story}\comment[id=K]{Working on it}
\comment[id=HM]{I think there is a story in here about risk conditional on past exposure
vs. prospective risk in gatherings, but it is too late to work through it. We might just
want to calculate the probabilities.}\comment[id=K]{Yes, we have both in the private
reasons. Retrospective after a case in the household and prospective in anticipation of
participation in a weekly meeting with friends. However, we cannot easily turn these
separately on and off at the moment as they use the same multiplier. We could do,
however, do this in the future.}
