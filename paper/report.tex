...
Pritchard2021}.}% the sources only report reduced viral shedding and reduced risk of infection.
...
the start of infectiousness.\comment[id=HM]{subsequent PCR tests, quarantine,
...
Figure~\ref{fig:model_for_official_cases}.\comment[id=HM]{Add a sentence.} A further
...
models on the model-generated data.\comment[id=HM]{Only keep if we actually do something
like that.}
...
4.% the week of Sep 13 had an incidence of 12.4, the week of Oct 18 had 51.
...
April\comment[id=HM]{Do we have the table somewhere?}\comment[id=K]{is in the empirical
analogues table}. In early March, some NPIs were being relaxed; e.g., hairdressers and
home improvement stores were allowed to open again to the public. In some cases,
customers were only allowed to enter with a recent negative rapid test result.
