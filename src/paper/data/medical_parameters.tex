...
% Latency Period
The first medical parameter we need is the distribution of the length of the period
between infection and the start of infectiousness, the so called latent period,
$\gamma_{infectious}$. \cite{Zhao2021} estimate the latent period to last 3.3 days (95\%
CI: 0.2, 7.9). In line with this estimate our latent period lasts one to five days with a
slightly lower average of two days.
