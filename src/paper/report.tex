...
\citep{Davies2020}.\label{r.2.b} A possible infection progresses as shown in
Figure~\ref{fig:model_disease_progression}. We differentiate between an initial period
...
\label{r.1.a}\Copy{r.1.a}{\cite{Bruemmer2021,Scheiblauer2021,Özcürümez2021};
...
tests, or seasonality. \label{r.1.b}\Copy{r.1.b}{In
    ...
    rapid tests. Even if we take a very pessimistic stance, the effect is only reduced from
    42\% to 38\%.}
