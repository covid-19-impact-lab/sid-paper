...
the disease bears the risk of transmitting the virus. Contacts occur in up to four networks:
...
contacts from diary data measuring contacts before the pandemic
...
profiles may appear. Vaccines may become available. During the
...
estimates of the share of detected cases and use data on the
