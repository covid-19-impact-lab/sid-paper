...
More details about the German model as well as applications to currently discussed German policies can be found in a companion paper (\citet{Dorn2020a}).\comment[id=T]{Needs to be updated with a reference to the new report.}
