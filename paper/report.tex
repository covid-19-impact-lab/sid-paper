...
We include two types of tests. Polymerase chain reaction (PCR) tests
directly\comment[id=J]{It is not clear what "directly" means} reveal whether an
...
private reasons becomes higher than compliance at the workplace.\comment[id=J]{Shouldn't
we mention that this is because of availability / high costs?}
...
CoViD-19 to get age-specific shares. For example,\comment[id=HM]{@Janos, please correct
...
Our analysis\comment[id=J]{The conclusion should be slightly longer and more separated from the rest} has shown that in the transition path to high levels of vaccination and
...
Instute back from March 2020 assuming a 2 month lockdown. I did not find anything citable
that is more recent. I did find
...
for self-administered rapid tests are frequently less than 1~Euro.\comment[id=HM]{Cheapest on
\href{https://amazon.de}{Amazon} on June 11th, 2021. --- DM 95ct}
