...
policies.}\comment[id=K]{Contreras2021 is not published but only on medrxiv} most have
...
the disease bears the risk of transmitting the virus. Contacts occur in up to four networks:
 \comment[id=J]{I would replace networks by areas because we have more than four networks}
...
transmit the virus \citep{Hunter2021, LevineTiefenbrun2021, Petter2021,
Pritchard2021}.\comment[id=K]{Hunter2021, Petter2021 and Pritchard not published
(medrxiv)}
...
is based on]{Gavenciak2021}.\comment[id=K]{Gavenciak2021 is not published} Nevertheless,
we estimate seasonality to be a quantitatively important factor determining the evolution
of the pandemic, explaining most of the early changes and 43\% of the cumulative
...
schools starting after Easter, at which point rapid tests had become widely available. We
...
estimated to have cost around 20~Euros per capita \citep{Wollmershauser2021}; retail
 \comment[id=J]{Check this number and add to which time period it refers}
...
on voluntary participation \citep[e.g.][]{StillmanTonin2021};\comment[id=K]{IZA DP} at
