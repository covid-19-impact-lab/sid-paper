...
\comment[id=J]{summarize the fit; Some of this needs to go in the appendix. I suggest the age group and federal state fit goes there???}
\comment[id=HM]{Also need to show simulated total infections somewhere. So far only shown for 2021.}
...
\comment[id=K]{The results can be found in `figures/results`. This includes both figures
