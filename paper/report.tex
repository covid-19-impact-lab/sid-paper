...
more specific once Appendix has new structure}. We keep the number of free parameters
...
March; 8\% in the model have ever done a rapid test at that point.}\comment[id=HM]{would
be great to have total tests performed in March, model vs. data is not important here.
Just first week of March looks too small} new infections on April 1 would be reduced by
...
\citep{Vlachos2021}\comment[id=HM]{Need a back-of the envelope calculation} To use
