...
infections by channel heatmap more prominently than the infection
probabilities}\comment[id=K]{Compare to
\href{https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3867682}{these estimates}}

% policies
We also estimate a parameter that reflects the effect of hygiene measures after November
2020 at work and in educational facilities. This parameter reduces infectiousness of
contacts by one third. In total those are ten parameters.\comment[id=K]{I think here you
refer to the other multipliers but you don't mention them. Also, since there is no change
on the 12th of April it's only nine changes} The breakpoints the contact reduction
