...
infectious and susceptible individuals bears the risk of transmitting the virus.
Contacts occur in up to four networks: Within the household, at
...
intensive care, and recovery or death \citep[similar to][]{Aleta2020}. The calibration
of the age dependent probabilities of transitioning between these states  is described
in Supplementary Material~\ref{sub:data_course_of_disease}). Conditional on the type of
contact, infectiousness is independent of age \citep{Jones2021}.
...
roll-out, priority may depend on age and occupation; vaccine hesitancy is modelled by
some individuals refusing vaccination offers. With some probability, vaccinated agents
become immune and do not transmit the virus \citep{Hunter2021, LevineTiefenbrun2021,
...
Examples are contact diaries, administrative records on case numbers, virus straints,
...
matches features of the data \citep[see][for the general method]{McFadden1989}.
...
Figure~\ref{fig:share_known_cases_by_age_group}).
% Our estimates suggest that---in the
...
The model is applied to the second and third waves of infections in Germany,
covering the period September 2020 to May 2021.
...
seasonality and school vacations. Second, the most stringent
...
\begin{figure}[!tp]
    ...
    \floatfoot{\noindent \textit{Note:} The blue line in
        ...
        are explained in Appendix~\ref{sub:shapley_value}.
        All lines are rolling 7-day averages.}
\end{figure}
...
individuals. By the end of our study period, when first-dose
vaccination rates reached 43\% of the population, the numbers of new cases would have
started to decline.

%It is important to note that the initial focus of the campaign was
...
% Despite the fact that only 10\% of the
...
at a fraction of the cost. A day of the fairly strict lockdown in early 2021 is
