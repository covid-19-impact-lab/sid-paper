...
Supplementary Material \ref{sec:model}]{McFadden1989}.\comment[id=HM]{Make reference more
...
absence of rapid testing---the detection rate is on average 80\% higher for individuals
