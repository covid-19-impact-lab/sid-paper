...
Figure~\ref{fig:model_disease_progression}.\comment[id=HM]{New version of figure has lost
the timing. Need to explain d-subscript, maybe even better to add stuff like 1-3 days
back in? Needs to be comprehensible without recurring to appendix} We differentiate
...
care, and recovery or death \citep[similar to][]{Aleta2020}. The probabilities of
...
infectiousness is independent of age \citep{Jones2021}.\comment[id=K]{would be
$\beta_{c}$}
