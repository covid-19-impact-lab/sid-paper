...
\begin{enumerate}
    ...
    \item They state that susceptibility is dependent on age. This requires references
          ...
          \response{%
              ...
              text. We do so now on Page~\ref{r.2.b}.
              ...
              differences, if existent, are likely not clinically relevant.
                  ...
                  {\bf \color{red} ToDo: Check paper suggestion
              ...
              In any case, while the jury is certainly still out on that particular
              issue, we are confident that different assumptions would not be quantitatively
              meaningful to change our results in a significant way.
