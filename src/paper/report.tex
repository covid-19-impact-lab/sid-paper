...
contact types. See Section~\ref{sec:policies} for details on how we model NPIs. In any
setting, mask mandates or air filters would reduce the probability of infection
\citep{Lessler2021, Cheng2021}.
...
viruses differs by age, the infectiousness is independent of age conditioned on the type
of contact \cite{Jones2021}.
...
mandatory tests at schools almost offset the increased infection risk of opening schools
(see Figure~\ref{fig:school_scenarios}).
