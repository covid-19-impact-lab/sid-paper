...
policies, vaccinations and rapid testing, we \replaced[id=K]{use the following}{propose a
different} model structure. \replaced[id=K]{}{It inherits many features from prototypical
agent-based simulation models but replaces the contacts between moving particles by
contacts between individuals who work, go to school, live in a household and enjoy
leisure activities.}\comment[id=K]{This has been moved to the Literature Review, I
think.}
...
participate in a weekly leisure meeting. Should we be more explicit here?} or
\replaced[id=K]{have a sick or positively tested household member}{observe cases in their
contact network}. People who have a positive rapid test demand a confirmatory PCR test
...
People who have symptoms\replaced[id=K]{ or}{,} received a positive test,
\replaced[id=K]{}{or had a risk contact} can reduce their number of contacts across all
